...
import { updatePost } from '@/lib/action/action';
import { getPostById } from '@/lib/action/action';
    ...
    <div className="min-h-screen bg-gray-50 font-sans">
      ...
      <div className="container mx-auto px-4 py-8">
        <div className="max-w-4xl mx-auto">
          {/* Page Header */}
          <div className="mb-8">
            <h1 className="text-3xl font-extrabold text-gray-900 mb-2">Update Post</h1>
            <p className="text-gray-600">Edit and improve your existing post</p>
          </div>

          <form id="update-post-form" onSubmit={handleSubmit} className="space-y-8">
            {/* Title */}
